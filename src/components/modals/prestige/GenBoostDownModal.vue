  ...
  computed: {
    ...
    message() {
      ...
      const keepDimensions = Perk.antimatterNoReset.canBeApplied || Achievement(111).canBeApplied ||
        ...
        You will gain a multiplier boost to your Down-type Generators in return. Are you sure you want to proceed?`;

      return `By peforming a Generator Boost on your Down-type generators, you will ${keepDimensions}`;
    },
  },
  methods: {
    handleYesClick() {
      requestDownGenBoost(this.bulk);
