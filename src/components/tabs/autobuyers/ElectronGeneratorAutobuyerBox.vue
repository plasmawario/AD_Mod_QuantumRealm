...
export default {
  ...
  computed: {
    autobuyer() {
      return Autobuyer.electronGenerator(this.tier);
    },
    name() {
      return `${ElectronGenerator(this.tier).shortDisplayName} Generator Autobuyer`;
    },
    modeDisplay() {
      switch (this.mode) {
      ...
      throw "Unknown Generator Autobuyer mode";
    }
  },
  methods: {
    update() {
